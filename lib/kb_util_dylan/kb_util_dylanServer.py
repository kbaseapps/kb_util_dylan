...
import os
from kb_util_dylan.authclient import KBaseAuth as _KBaseAuth
...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'kb_util_dylan'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from kb_util_dylan.kb_util_dylanImpl import kb_util_dylan  # noqa @IgnorePep8
impl_kb_util_dylan = kb_util_dylan(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'kb_util_dylan'
